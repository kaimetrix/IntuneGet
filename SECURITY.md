...
- The service principal requires DeviceManagementApps.ReadWrite.All, DeviceManagementServiceConfig.ReadWrite.All, and DeviceManagementConfiguration.Read.All (broad permissions)
