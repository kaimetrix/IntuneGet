      ...
      <div className="flex items-start gap-3 p-3 bg-status-warning/10 border border-status-warning/20 rounded-lg">
        ...
        <div className="flex-1">
          ...
          <p className="text-status-warning/70 text-xs mt-1">
            The app needs DeviceManagementApps.ReadWrite.All, DeviceManagementManagedDevices.Read.All, DeviceManagementServiceConfig.ReadWrite.All (for ESP profiles), and DeviceManagementConfiguration.Read.All (for assignment filters). Please re-grant admin consent.
          </p>
          <div className="flex gap-2 mt-3">
            <Button
              size="sm"
