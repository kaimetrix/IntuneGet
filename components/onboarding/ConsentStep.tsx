    ...
    return (
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-text-muted mb-6">
          ...
          <code className="text-amber-600 bg-amber-500/10 px-1 rounded ml-1">DeviceManagementServiceConfig.ReadWrite.All</code> (for ESP profiles), and
          <code className="text-amber-600 bg-amber-500/10 px-1 rounded ml-1">DeviceManagementConfiguration.Read.All</code> (for assignment filters).
